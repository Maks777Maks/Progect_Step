        ...
        public override void Up()
        {
            ...
            CreateTable(
                ...
                c => new
                    {
                        ID = c.Int(nullable: false, identity: true),
                        Fuel_UA = c.String(nullable: false),
                        Fuel_RUS = c.String(nullable: false),
                        Fuel_EN = c.String(nullable: false),
                    })
                .PrimaryKey(t => t.ID);
            ...
            CreateTable(
                ...
                c => new
                    {
                        ID = c.Int(nullable: false, identity: true),
                        Name_UA = c.String(nullable: false),
                        Name_RUS = c.String(nullable: false),
            ...
            CreateTable(
                ...
                c => new
                    {
                        ID = c.Int(nullable: false, identity: true),
                        transmission_UA = c.String(nullable: false),
                        transmission_RUS = c.String(nullable: false),
                        transmission_EN = c.String(nullable: false),
                    })
                .PrimaryKey(t => t.ID);
